...
graph_type = 'barchart'
#max_dose = np.array([1,100,500,1000])
max_dose = np.array([1])
#max_dose = np.array([0])
...
#    drug_curve_t = conv*dose
    for sim_num in range(n_sims):
        counts_t, drug_curve, counts_ab, counts_vect  = hybrid_sim.hybrid_evol_2(drugless_rates,
                                        ic50_pyr,
                                        n_gen=n_gen,  # Number of simulated generations
                                        mut_rate=mut_rate,  # probability of mutation per generation
                                        max_cells=max_cells,  # Max number of cells
...
#abm_bar_ax.set_ylabel('Percent Survival',fontsize=20)
...
#vect_bar_ax.set_ylabel('Percent Survival',fontsize=20)
...
#hyb_bar_ax.set_ylabel('Percent Survival',fontsize=20)
